...
import 'piccolore';
import { m as maybeRenderHead, h as addAttribute, k as renderTemplate, w as defineScriptVars, o as renderComponent, p as renderSlot, x as renderHead } from './entrypoint_DPvAqX-D.mjs';
import 'clsx';
...
const $$ParkedGate = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(["", '<div class="parked-gate" id="parked-gate" data-astro-cid-zwbqjuuf> <div class="parked-gate__content" data-astro-cid-zwbqjuuf> <p class="parked-gate__text" id="parked-text" data-astro-cid-zwbqjuuf>parked</p> <p class="parked-gate__redirect" id="parked-redirect" data-astro-cid-zwbqjuuf>redirecting…</p> <div class="parked-gate__runway" data-astro-cid-zwbqjuuf> <div class="parked-gate__scene" aria-hidden="true" data-astro-cid-zwbqjuuf> <div class="parked-gate__sun" data-astro-cid-zwbqjuuf></div> <div class="parked-gate__cloud parked-gate__cloud--1" data-astro-cid-zwbqjuuf></div> <div class="parked-gate__cloud parked-gate__cloud--2" data-astro-cid-zwbqjuuf></div> <div class="parked-gate__cloud parked-gate__cloud--3" data-astro-cid-zwbqjuuf></div> <div class="parked-gate__treeline" data-astro-cid-zwbqjuuf></div> <div class="parked-gate__grass" data-astro-cid-zwbqjuuf></div> <div class="parked-gate__windsock" data-astro-cid-zwbqjuuf> <span class="parked-gate__windsock-flag" data-astro-cid-zwbqjuuf></span> </div> <div class="parked-gate__strip" data-astro-cid-zwbqjuuf> <div class="parked-gate__strip-threshold" data-astro-cid-zwbqjuuf></div> <span class="parked-gate__strip-numbers" data-astro-cid-zwbqjuuf>27</span> <div class="parked-gate__strip-centerline" data-astro-cid-zwbqjuuf></div> </div> </div> <img class="parked-gate__plane parked-gate__plane--takeoff" id="parked-plane" src="/images/rc-plane.svg" alt="" width="360" height="132" loading="eager" decoding="async" data-astro-cid-zwbqjuuf> </div> </div> </div> <script>(function(){', "\n  const STORAGE_KEY = 'brrc-unlocked';\n  const CLICKS_NEEDED = 10;\n\n  const gate = document.getElementById('parked-gate');\n  const text = document.getElementById('parked-text');\n  const plane = document.getElementById('parked-plane');\n\n  if (gate && text && sessionStorage.getItem(STORAGE_KEY) !== 'true') {\n    let clicks = 0;\n    let unlocked = false;\n    let redirectTimer;\n\n    function cancelRedirect() {\n      window.clearTimeout(redirectTimer);\n      plane?.classList.remove('parked-gate__plane--takeoff');\n    }\n\n    function unlock() {\n      unlocked = true;\n      cancelRedirect();\n      sessionStorage.setItem(STORAGE_KEY, 'true');\n      document.documentElement.removeAttribute('data-parked');\n      gate.hidden = true;\n    }\n\n    text.addEventListener('click', () => {\n      clicks += 1;\n      if (clicks >= CLICKS_NEEDED) {\n        unlock();\n      }\n    });\n\n    redirectTimer = window.setTimeout(() => {\n      if (!unlocked) {\n        window.location.href = FACEBOOK_URL;\n      }\n    }, REDIRECT_MS);\n  } else if (gate) {\n    gate.hidden = true;\n  }\n})();<\/script>"])), maybeRenderHead(), defineScriptVars({ REDIRECT_MS, FACEBOOK_URL }));
