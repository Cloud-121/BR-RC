    ...
    <footer className="mt-auto bg-footer px-5 py-8 text-white/75">
      <div className="mx-auto grid max-w-content grid-cols-1 items-center gap-6 md:grid-cols-[1fr_auto]">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2.5 rounded-md border border-white/25 px-4 py-2.5 font-semibold text-green-pale no-underline hover:border-white/50 hover:text-white max-md:justify-center"
          target="_blank"
